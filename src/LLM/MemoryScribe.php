...
class MemoryScribe {
    ...
    public const SCRIBE_PROMPT = "Ты — служебный экстрактор фактов из транскрипта чата. Не персонаж, без мнений.\n"
        . "Выдели из приведённых сообщений: (1) УСТОЙЧИВЫЕ факты об участниках, (2) новые локальные шутки/мемы/легенды чата.\n"
        . "Устойчивый факт — черта человека, которая останется верной через месяц: интересы, привычки, род занятий, "
        . "роль в чате, манера речи. НЕ факт: разовые покупки, сиюминутные оценки и впечатления, события сегодняшнего дня, "
        . "что человек делает прямо сейчас. Пример негодного: «попробовал сидр — не понравилось». "
        . "Пример годного: «разбирается в сидре и любит сравнивать сорта».\n"
        ...
        . "Используй ТОЛЬКО ники из списка участников. Сомневаешься в устойчивости факта — НЕ записывай. "
        . "Если достойного материала нет — ответь одним словом: NONE.";
