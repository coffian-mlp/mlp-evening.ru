        ...
        if ($triggerType === 'mention') {
            ...
            */
            ...
            if ($event) {
                ...
                $additionalPrompt .= "\nТВОЯ ЗАДАЧА: Напиши красивый анонс или ответ на основе этих новых данных. Можешь как-то связать это с текущей беседой в чате, но информация о событии должна быть выдана на 100%! Игнорируй ограничения на длину ответа.";
            } else {
