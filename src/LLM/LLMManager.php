        ...
        if ($triggerType === 'mention') {
            ...
            */
            ...
            $additionalPrompt = "\n\n=== ВАЖНОЕ СИСТЕМНОЕ СООБЩЕНИЕ ДЛЯ БОТА ===\n"
                ...
                . "Запрещено: упоминать чат/переписку/сообщения/\"вы спросили\"/\"как выше\"/\"я думаю\"/\"мне кажется\"; задавать вопросы; спорить; рассуждать; писать дисклеймеры.\n"
                . "Правило фактов: используй ТОЛЬКО данные ниже. Ничего не выдумывай и не добавляй деталей от себя.\n"
                . "Формат ответа: Markdown.\n"
                . "- Заголовок: '## ...'\n"
                . "- Затем 3–6 буллетов, каждый с жирным ключом (**Когда**, **Что**, **Описание**, **Плейлист** — по уместности)\n"
                . "- Заверши одной короткой строкой-призывом без вопросов. Но дай свое мнение по поводу события, если это возможно. Можешь пошутить.\n"
