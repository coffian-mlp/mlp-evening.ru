    ...
    <!-- Конец контента -->
    <script src="/assets/js/main.js?v=<?= file_exists(__DIR__ . '/../../assets/js/main.js') ? filemtime(__DIR__ . '/../../assets/js/main.js') : time() ?>" charset="utf-8"></script>
    ...
    <?php if (isset($enableLocalChat) && $enableLocalChat): ?>
        <script src="/assets/js/local-chat.js?v=<?= file_exists(__DIR__ . '/../../assets/js/local-chat.js') ? filemtime(__DIR__ . '/../../assets/js/local-chat.js') : time() ?>" charset="utf-8"></script>
    <?php endif; ?>
</body>
</html>
