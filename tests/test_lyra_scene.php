...
ok(LyraArtist::appearance([], '#ff1e63') === LyraArtist::colorName('#ff1e63') . ' coat (#ff1e63)', 'без памяти — цвет шёрстки из цвета ника');
...
ok(str_contains($h2, "\nВнешность (для художника): CoFFian — ") && str_contains($h2, 'coat (#ff1e63).') && !str_contains($h2, 'Назар —'), 'блок внешности: только у тех, кого можно отличить: ' . $h2);
